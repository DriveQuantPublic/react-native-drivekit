package com.awesomelibraryexample;
...
import com.awesomelibraryexample.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.awesomelibraryexample.ReactNativeFlipper");
        aClass
