...
object TripsSyncMappers {
  ...
  internal fun Trip.toReadableMap(): ReadableMap {
    ...
    map.putString("departurePostalCode", departurePostalCode)
    map.putString("departureState", departureState)
    map.putString("departureCountry", departureCountry)
    map.putString("arrivalAddress", arrivalAddress)
    map.putString("arrivalCity", arrivalCity)
    map.putString("arrivalPostalCode", arrivalPostalCode)
    map.putString("arrivalState", arrivalState)
    map.putString("arrivalCountry", arrivalCountry)
