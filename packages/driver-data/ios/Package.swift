...
// <app>/ios/build/generated/autolinking/libs/RNDriveKitDriverData, so the relative
...
let package = Package(
    name: "RNDriveKitDriverData",
    platforms: [.iOS(.v15)],
    products: [
        .library(name: "RNDriveKitDriverData", targets: ["RNDriveKitDriverDataObjC"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            name: "RNDriveKitDriverDataSwift",
            dependencies: [
                .product(name: "ReactHeaders", package: "ReactNative"),
        ...
        .target(
            name: "RNDriveKitDriverDataObjC",
            dependencies: [.target(name: "RNDriveKitDriverDataSwift")] + reactDependencies,
            path: ".",
            sources: [
                "RNDriveKitDriverData.mm",
            ],
