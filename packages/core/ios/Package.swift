...
// <app>/ios/build/generated/autolinking/libs/RNDriveKitCore, so the relative
...
let package = Package(
    ...
    platforms: [.iOS(.v15)],
    products: [
        .library(name: "RNDriveKitCore", targets: ["RNDriveKitCoreObjC"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            ...
            sources: [
                ...
                "RNDriveKitCoreWrapper.swift",
                "UserInfoMappers.swift",
            ]
        ),
        .target(
            name: "RNDriveKitCoreObjC",
            dependencies: [.target(name: "RNDriveKitCoreSwift")] + reactDependencies,
            path: ".",
            sources: [
                "RNDriveKitCore.mm",
            ],
