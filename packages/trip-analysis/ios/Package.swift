...
// <app>/ios/build/generated/autolinking/libs/RNDriveKitTripAnalysis, so the relative
...
let package = Package(
    name: "RNDriveKitTripAnalysis",
    platforms: [.iOS(.v15)],
    products: [
        .library(name: "RNDriveKitTripAnalysis", targets: ["RNDriveKitTripAnalysisObjC"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .target(
            name: "RNDriveKitTripAnalysisSwift",
            dependencies: [
                .product(name: "ReactHeaders", package: "ReactNative"),
            ...
            sources: [
                ...
                "RNDriveKitTripAnalysisWrapper.swift",
        ...
        .target(
            name: "RNDriveKitTripAnalysisObjC",
            dependencies: [.target(name: "RNDriveKitTripAnalysisSwift")] + reactDependencies,
            path: ".",
            sources: [
                "RNDriveKitTripAnalysis.mm",
            ],
