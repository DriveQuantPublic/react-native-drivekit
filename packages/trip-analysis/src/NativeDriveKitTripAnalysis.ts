...
export enum GetTripSharingLinkStatus {
  SUCCESS = 'SUCCESS',
  FAILED_TO_GET_CACHE_ONLY = 'FAILED_TO_GET_CACHE_ONLY',
  USER_NOT_CONNECTED = 'USER_NOT_CONNECTED',
  UNAUTHENTICATED = 'UNAUTHENTICATED',
  FORBIDDEN = 'FORBIDDEN',
...
export enum TripResponseInfo {
  ENGINE_SPEED_NOT_AVAILABLE = 'ENGINE_SPEED_NOT_AVAILABLE',
  ENGINE_SPEED_IS_NULL = 'ENGINE_SPEED_IS_NULL',
  NO_VEHICLE_CHARACTERISTICS = 'NO_VEHICLE_CHARACTERISTICS',
  DATA_LOSS = 'DATA_LOSS',
  DISTANCE_TOO_SHORT = 'DISTANCE_TOO_SHORT',
  INVALID_VEHICLE_CHARACTERISTICS = 'INVALID_VEHICLE_CHARACTERISTICS',
  INVALID_VEHICLE_ID = 'INVALID_VEHICLE_ID',
}

export enum TripResponseError {
  NO_ACCOUNT_SET = 'NO_ACCOUNT_SET',
  NO_ROUTE_OBJECT_FOUND = 'NO_ROUTE_OBJECT_FOUND',
  INVALID_ROUTE_DEFINITION = 'INVALID_ROUTE_DEFINITION',
  NO_VELOCITY_DATA = 'NO_VELOCITY_DATA',
  INVALID_SAMPLING_PERIOD = 'INVALID_SAMPLING_PERIOD',
  INVALID_CUSTOMER_ID = 'INVALID_CUSTOMER_ID',
  NO_DATE_FOUND = 'NO_DATE_FOUND',
  MAX_DAILY_REQUEST_NUMBER_REACHED = 'MAX_DAILY_REQUEST_NUMBER_REACHED',
  DATA_ERROR = 'DATA_ERROR',
  INVALID_ROUTE_VECTORS = 'INVALID_ROUTE_VECTORS',
  MISSING_BEACON = 'MISSING_BEACON',
  INVALID_BEACON = 'INVALID_BEACON',
  DUPLICATE_TRIP = 'DUPLICATE_TRIP',
  INSUFFICIENT_GPS_DATA = 'INSUFFICIENT_GPS_DATA',
